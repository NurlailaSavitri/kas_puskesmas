            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel"><?= ($editMode) ? 'Edit' : 'Add' ?> Pasien</h5>
                    ...
                    <form class="form-horizontal" method="POST" action="save_pasien.php">
                        <div class="modal-body">
                            <div class="col-md-12">
                                ...
                                <input type="text" value="<?= ($editMode) ? $pasien->kode_pasien : '' ?>" name="kode_pasien" class="form-control" placeholder="Masukan Kode Pasien">
                            </div>
                            <div class="form-row">
                                <div class="col-md-12">
                                    <label for="nama_pasien">Nama Pasien</label>
                                    <input type="text" value="<?= ($editMode) ? $pasien->nama_pasien : '' ?>" name="nama_pasien" class="form-control" placeholder="Masukan Nama Pasien">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <label>Jenis Kelamin</label>
                                <select class="form-select form-control" aria-label="Default select example" name="jenis_pasien">
                                    <option selected disabled><?= ($editMode) ? $pasien->jenis_pasien : 'Jenis Kelamin' ?></option>
                            ...
                            <div class="form-row">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" value="<?= ($editMode) ? $pasien->tempat_lahir : '' ?>" name="tempat_lahir" class="form-control" placeholder="Masukan Tempat Lahir">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col-md-12">
                                    <label for="tanggal_lahir">Tanggal Lahir</label>
                                    <input type="date" value="<?= ($editMode) ? $pasien->tanggal_lahir : '' ?>" name="tanggal_lahir" class="form-control" placeholder="Masukan Tanggal Lahir">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col-md-12">
                                    <label for="alamat_pasien">Tempat Tinggal</label>
                                    <input type="text" value="<?= ($editMode) ? $pasien->alamat_pasien : '' ?>" name="alamat_pasien" class="form-control" placeholder="Masukan Tempat Tinggal">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col-md-12">
                                    <label for="nomor_telphone">Nomor Telepon</label>
                                    <input type="text" value="<?= ($editMode) ? $pasien->nomor_telphone : '' ?>" name="nomor_telphone" class="form-control" placeholder="Masukan Nomor Telepon">
                                </div>
                            </div>
                        </div>
